      ...
      <div className="ml-64">
        ...
        <header className="sticky top-0 z-30 bg-slate-900/50 border-b border-slate-700/50 backdrop-blur px-8 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-400 mt-1">Detailed insights into your nutrition and compliance</p>
          </div>
          <div className="flex items-center gap-4">
            <button className="flex items-center gap-2 px-4 py-2 hover:bg-slate-800 rounded-lg transition-colors">
