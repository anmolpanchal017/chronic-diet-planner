...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-900">
      {/* Navbar */}
      <header className="sticky top-0 z-50 bg-slate-900/50 backdrop-blur border-b border-slate-700/50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="text-white font-bold text-lg hidden sm:block">NutriPlan AI</div>
          </Link>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          ...
          <button
            className="btn border-2 border-slate-500 text-white hover:bg-slate-800"
          >
            View Demo
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          <div className="card p-6 bg-gradient-to-br from-blue-600 to-blue-700 border border-blue-500/80 hover:border-blue-400 hover:shadow-2xl hover:shadow-blue-500/40 transition-all duration-300 cursor-pointer scale-100 hover:scale-105">
            ...
            <h3 className="font-bold text-white mb-2 text-lg">Diabetes Profile</h3>
          ...
          <div className="card p-6 bg-gradient-to-br from-amber-500 to-amber-600 border border-amber-500/80 hover:border-amber-400 hover:shadow-2xl hover:shadow-amber-500/40 transition-all duration-300 cursor-pointer scale-100 hover:scale-105">
            ...
            <h3 className="font-bold text-white mb-2 text-lg">CKD Profile</h3>
          ...
          <div className="card p-6 bg-gradient-to-br from-pink-600 to-rose-700 border border-pink-500/80 hover:border-pink-400 hover:shadow-2xl hover:shadow-pink-500/40 transition-all duration-300 cursor-pointer scale-100 hover:scale-105">
            ...
            <h3 className="font-bold text-white mb-2 text-lg">Heart Disease</h3>
        ...
        <div id="features" className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          <div className="card p-8 bg-slate-800/90 border border-emerald-500/40 hover:border-emerald-400/80 hover:bg-slate-800 hover:shadow-2xl hover:shadow-emerald-500/20 text-left transition-all duration-300">
            <CheckCircle2 className="w-8 h-8 text-emerald-400 mb-4" />
            <h3 className="text-xl font-bold text-white mb-3">Multi-Condition Support</h3>
            <p className="text-slate-300">
              Supports Diabetes, Hypertension, CKD, Heart Disease, Obesity, and PCOD with condition-specific nutrition targets.
            </p>
          </div>

          <div className="card p-8 bg-slate-800/90 border border-teal-500/40 hover:border-teal-400/80 hover:bg-slate-800 hover:shadow-2xl hover:shadow-teal-500/20 text-left transition-all duration-300">
            <CheckCircle2 className="w-8 h-8 text-teal-400 mb-4" />
            <h3 className="text-xl font-bold text-white mb-3">Lab-Aware Planning</h3>
            <p className="text-slate-300">
              Upload medical reports to auto-extract lab values and detect conditions for personalized recommendations.
            </p>
          </div>

          <div className="card p-8 bg-slate-800/90 border border-blue-500/40 hover:border-blue-400/80 hover:bg-slate-800 hover:shadow-2xl hover:shadow-blue-500/20 text-left transition-all duration-300">
          ...
          <div className="card p-8 bg-slate-800/90 border border-amber-500/40 hover:border-amber-400/80 hover:bg-slate-800 hover:shadow-2xl hover:shadow-amber-500/20 text-left transition-all duration-300">
            <CheckCircle2 className="w-8 h-8 text-amber-400 mb-4" />
            <h3 className="text-xl font-bold text-white mb-3">Indian Cuisine Database</h3>
            <p className="text-slate-300">
